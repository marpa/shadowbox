...
Variation Name: Gray White Gradient ShadowBox
Variation id: shadowbox-gray-white
...
if ($options['background'] == "shadowbox-gray-white") {

	$options['background_image_file'] = "bg_topdark.jpg";
	$options['background_image_directory'] = "shadowbox-gray-white";	
