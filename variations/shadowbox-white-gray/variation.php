...
Variation Name: White Gray Gradient ShadowBox
Variation id: shadowbox-white-gray
...
if ($options['background'] == "shadowbox-white-gray") {

	$options['background_image_file'] = "bg_toplight.jpg";
	$options['background_image_directory'] = "shadowbox-white-gray";	
